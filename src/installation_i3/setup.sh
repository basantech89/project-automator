...
install_file_system_config() {
  install_pkgs pacman mtpfs ntfs-3g gvfs xarchiver pcmanfm
...
install_i3() {
  ...
  update_system
  install_pkgs pacman openssl openssh xorg xorg-xinit xorg-server i3-gaps accountsservice argyllcms colord-sane libcanberra-pulse libcanberra-gstreamer lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings i3status
